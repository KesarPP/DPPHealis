  ...
  Widget _buildHeaderCard(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(
          top: MediaQuery.of(context).size.height * 0.06), // Reposition higher
      child: Align(
        alignment: Alignment.center,
        child: Container(
          padding: const EdgeInsets.symmetric(
              vertical: 8, horizontal: 24), // Adjusted horizontal padding
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Container(
                      width: 15, height: 1, color: const Color(0xFFE5A8B8)),
                  const Padding(
                    padding: EdgeInsets.symmetric(horizontal: 6.0),
                    child: Icon(Icons.favorite,
                        color: Color(0xFFD96B85), size: 10),
                  ),
                  Container(
                      width: 15, height: 1, color: const Color(0xFFE5A8B8)),
                ],
        ...
        children: [
          ...
          Transform(
            ...
            transform: Matrix4.identity()
              ..setEntry(3, 2, 0.0015)
              ..rotateX(-0.15)
              ..scale(0.8075, 0.85, 1.0) // Reduced width by 5% relative to original 0.85
                  ...
                  Expanded(
                    child: Transform(
                      ...
                      transform: Matrix4.identity()
                        ..setEntry(3, 2, 0.0015)
                        ..rotateX(-0.15)
                        ..scale(0.8075, 0.85, 1.0) // Decreased width by 5% relative to original 0.85
                        ..translate(0.0, -15.0,
                            0.0), // Shifted up to keep top edge anchored
                      child: Padding(
                        padding: EdgeInsets.only(
...
class _OpenBookInteriorState extends State<_OpenBookInterior> {
  final GlobalKey<PageTurnWidgetState> _pageTurnKey =
      GlobalKey<PageTurnWidgetState>();
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
              color: ManuscriptColors.gold.withValues(alpha: 0.5), width: 1),
        ),
        child: Row(
          children: [
            ...
            const Icon(Icons.arrow_forward_ios_rounded,
                color: ManuscriptColors.darkWood, size: 14),
          ],
        ),
      ),
    );
              ...
              children: [
                ClipRect(
                  child: Image.asset(
                    'assets/images/session_timeline/manuscript_page_left_new.png',
                    fit: BoxFit
                        .contain, // Changed from cover to contain to fit its native rounded corners
                ...
                Positioned.fill(
                  child: Padding(
                    padding: EdgeInsets.only(
                      ...
                      left: 45,
                      right:
                          55, // Increased to prevent bleeding into the right side
                      bottom: 40,
                    ),
                    child: Column(
                          ...
                          child: Stack(
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: const Color(0xFFFBB8D0).withValues(
                                      alpha: 0.2), // Pastel Pink Tint
                                  borderRadius: BorderRadius.circular(16),
                                  border: Border.all(
                                      color: const Color(0xFF81C784)
                                          .withValues(alpha: 0.8),
                                      width: 4), // Health Green border
                                  boxShadow: [
                                    BoxShadow(
                                      color: const Color(0xFFD96B85)
                                      ...
                                      Container(
                                        decoration: const BoxDecoration(
                                          gradient: LinearGradient(
                                            ...
                                            colors: [
                                              Color(
                                                  0xFFE1F5FE), // Light Pastel Blue
                                              Color(
                                                  0xFFF3E5F5), // Light Pastel Purple
                                            ],
                                          ),
                                        ),
                                        child: const Icon(
                              ...
                              // Enhanced Health Elements Around the Frame
                              const Positioned(
                                  top: -16,
                                  left: -16,
                                  child: Text('🌿',
              ...
              children: [
                ClipRect(
                  child: Image.asset(
                    'assets/images/session_timeline/manuscript_page_right_new.png',
                    fit: BoxFit
                        .contain, // Fit like a page without cropping or zooming
                    errorBuilder: (c, e, s) => const SizedBox.shrink(),
                  ),
                ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    _buildActionCard(
                                      ...
                                      subtitle:
                                          'View and download resources from today\'s session.',
                                      onTap: () {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                    ...
                                    _buildActionCard(
                                      ...
                                      title: 'Meal Log',
                                      subtitle:
                                          'Log your meals and build healthier habits.',
                                      onTap: () {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                    ...
                                    _buildActionCard(
                                      ...
                                      title: 'Activity',
                                      subtitle:
                                          'Record your activities and stay active every day.',
                                      onTap: () {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  const ActivityFitnessScreen()),
                                        );
                                      },
                                    ),
                                    const Spacer(),
                ...
                children: [
                  ...
                  AnimatedBuilder(
                    ...
                    builder: (context, child) {
                      ...
                      if (progress < 0.1) {
                        highlightPos = -1.0 +
                            (progress * 20.0); // maps 0.0->0.1 to -1.0->1.0
                      } else {
                        highlightPos =
                            2.0; // keep offscreen for the rest of the loop
                      }
