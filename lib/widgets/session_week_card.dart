    ...
    switch (state) {
      ...
      case WeekCardState.current:
        return BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: ManuscriptColors.gold.withValues(alpha: 0.25 + glowStrength * 0.25),
      ...
      case WeekCardState.perfect:
        return BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: ManuscriptColors.gold.withValues(alpha: 0.4 + glowStrength * 0.3),
      ...
      children: [
        ClipRRect(
          ...
          child: Container(
            width: 52,
            height: 52,
            color: ManuscriptColors.darkBrown.withValues(alpha: 0.08),
            child: Image.asset(
      ...
      children: [
        ...
        ClipRRect(
          ...
          child: LinearProgressIndicator(
            ...
            minHeight: 5,
            backgroundColor: ManuscriptColors.darkBrown.withValues(alpha: 0.08),
