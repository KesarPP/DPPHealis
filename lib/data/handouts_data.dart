...
const List<ModuleHandout> foodHandouts = [
  ModuleHandout(1, 'Understanding Prediabetes & Nutrition Foundations', [
    ...
    SessionHandout('Session 2: Become a Fat & Calorie Detective', [
      ...
      HandoutItem(3, 'Types of Fat'),
      HandoutItem(4, 'Why Fat Type Matters'),
      HandoutItem(5, 'Sources of Fat'),
      HandoutItem(6, 'Hidden Calories and Hidden Fat'),
      HandoutItem(7, 'Why Hidden Calories Matter'),
    ]),
    SessionHandout('Session 3: Reducing Fat & Calories', [
      HandoutItem(1, 'Understanding Calorie-Dense Foods'),
      HandoutItem(2, 'Reducing Fat Intake'),
      HandoutItem(3, 'Everyday Fat Reduction Strategies'),
      HandoutItem(4, 'Reducing Calories Without Feeling Deprived'),
      HandoutItem(5, 'Food Preparation Strategies'),
    ]),
    SessionHandout('Session 4: Healthy Eating for Life', [
      HandoutItem(1, 'Principles of Healthy Eating'),
      HandoutItem(2, 'Healthy Eating with Variety and Balance'),
      HandoutItem(3, 'Fruits and Vegetables'),
      HandoutItem(4, 'More Volume, Fewer Calories'),
      HandoutItem(5, 'Understanding Fiber'),
      HandoutItem(6, 'Recipe Modification'),
      HandoutItem(7, 'Mindful Eating'),
    ]),
  ]),
];
